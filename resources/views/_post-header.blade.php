    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:flex lg:inline-flex lg:items-center bg-gray-100 rounded-xl">
            <div x-data="{show :false}" @click.away ="show = false">
                <button @click="show = !show" class="py-2 pl-3 pr-9 text-sm font-semibold text-left w-full lg:w-36 inline-flex">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl z-10" style="display: none;">
                    ...
                    @foreach($categories as $category)
                        <a href="/categories/{{$category->slug}}"
                            class="block text-left px-3 text-sm leading-6 hover:bg-gray-200 focus:bg-gray-200
                                {{ isset($currentCategory) && $currentCategory->is($category) ? ' bg-gray-200' : '' }}
                             ">
